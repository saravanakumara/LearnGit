...
8. Create a link to the remote Repo from your local repo by,
	...
	*git remote - used to edit a configuration file on your own computer i.e it will update the .git/.config file on the local system*
